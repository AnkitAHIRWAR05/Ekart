...
const Footer =()=>{
    return (
        <footer className='bg-gray-900 text-gray-200 py-10'>
            <div className='max-w-7xl mx-auto px-4 md:flex md:justify-between'>
                ...
                <div className='mb-6 md:mb-0'>
                   ...
                   <div className="flex items-center">
                        <img src="/e.png" alt="logo" className="w-[60px] h-[60px]" />
                        <h1 className="text-2xl font-bold text-pink-600 -ml-2 -mt-1">KART</h1>
</div>
            ...
            {/* bottom section */}
            <div className='mt-8 border-t border-grey-700 pt-6 text-center text-sm'>
